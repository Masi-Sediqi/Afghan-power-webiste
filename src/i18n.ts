...
const fa: Dictionary = {
  ...
  'Explore products by company': 'محصولات را بر اساس بخش بررسی کنید',
  'View all products': 'مشاهده همه محصولات',
  'Educational Products': 'محصولات تحصیلی',
  'Travel Products': 'محصولات سیاحتی',
  'Tech Products': 'محصولات تکنالوژی',
  'Media Products': 'محصولات رسانه‌ای',
  'Study, admission, scholarship and student visa packages.': 'بسته‌های تحصیلی، پذیرش، بورسیه و ویزای محصلی.',
  'Tourist visa, ticketing, family travel and tour packages.': 'بسته‌های ویزای توریستی، تکت، سفر خانوادگی و تور.',
  'Ready-made databases, ERP platforms and business systems.': 'دیتابیس‌های آماده، پلتفرم‌های ERP و سیستم‌های تجارتی.',
  'Advertising, social media, video and branding packages.': 'بسته‌های تبلیغات، شبکه‌های اجتماعی، ویدیو و برندینگ.',
  ...
  'ABOUT AFGHAN POWER GROUP': 'درباره افغان پاور گروپ',
  'WHO WE ARE': 'ما کی هستیم',
  'OUR COMPANIES': 'شرکت‌های ما',
  'WHY AFGHAN POWER GROUP': 'چرا افغان پاور گروپ',
  '04 · CORE COMPANIES': '۰۴ · شرکت‌های اصلی',
  'Group of Companies': 'گروپ شرکت‌ها',
  'Explore Education': 'مشاهده خدمات تحصیلی',
  'Explore Travel': 'مشاهده خدمات سفر',
  'Explore Technology': 'مشاهده خدمات تکنالوژی',
  'Explore Media': 'مشاهده خدمات رسانه‌ای',
  'Explore our education, travel, technology and media services.': 'خدمات تحصیلی، سفر، تکنالوژی و رسانه‌ای ما را بررسی کنید.',
  'From education and travel to technology and media, Afghan Power Group brings specialized services together under one trusted group.': 'از تحصیلات و سفر تا تکنالوژی و رسانه، افغان پاور گروپ خدمات تخصصی را زیر یک مجموعه معتبر گردهم آورده است.',
  'One Group. Multiple': 'یک مجموعه. چندین',
  'Specialized Companies.': 'شرکت تخصصی.',
  'MULTIPLE SOLUTIONS': 'راهکارهای متعدد',
  'Education · Travel · Tech · Media': 'تحصیلات · سفر · تکنالوژی · رسانه',
  'Study Abroad & Educational Services': 'تحصیل در خارج و خدمات آموزشی',
  'University admissions, scholarships, study visa guidance and international education opportunities.': 'پذیرش دانشگاه، بورسیه، راهنمایی ویزای تحصیلی و فرصت‌های تحصیل بین‌المللی.',
  'Travel, Visa & Ticketing Services': 'خدمات سفر، ویزا و تکت',
  'Professional travel services including tourist visas, flight tickets and complete travel assistance.': 'خدمات حرفه‌ای سفر شامل ویزای توریستی، تکت هوایی و پشتیبانی کامل سفر.',
  'Software & Digital Solutions': 'نرم‌افزار و راهکارهای دیجیتال',
  'Modern software solutions, business systems and custom technology built for organizations and businesses.': 'راهکارهای مدرن نرم‌افزاری، سیستم‌های تجارتی و تکنالوژی اختصاصی برای سازمان‌ها و تجارت‌ها.',
  'Creative Media & Digital Marketing': 'رسانه خلاق و بازاریابی دیجیتال',
  'Creative media services designed to strengthen brands, promote businesses and produce professional digital content.': 'خدمات خلاق رسانه‌ای برای تقویت برندها، معرفی تجارت‌ها و تولید محتوای حرفه‌ای دیجیتال.',
  'Study abroad services': 'خدمات تحصیل در خارج',
  'Tourist visa services': 'خدمات ویزای توریستی',
  'Software & databases': 'نرم‌افزار و دیتابیس',
  'Media production': 'تولیدات رسانه‌ای',
  'Air Tickets': 'تکت‌های هوایی',
  'Travel Consultation': 'مشاوره سفر',
  'Custom Databases': 'دیتابیس‌های اختصاصی',
  'ERP Systems': 'سیستم‌های ERP',
  'Mobile Applications': 'اپلیکیشن‌های موبایل',
  'Video Production': 'تولید ویدیو',
  'Graphic Design': 'طراحی گرافیک',
  'Digital Marketing': 'بازاریابی دیجیتال',
  'Smart Gold': 'اسمارت گولد',
  'Fuel Station ERP': 'ERP پمپ تیل',
  'Hospital Management': 'مدیریت شفاخانه',
  'Pharmacy ERP': 'ERP دواخانه',
  'Restaurant System': 'سیستم رستورانت',
  ...
  'Live Demo': 'دموی زنده',
  'Watch the product overview, interface and key workflow directly from YouTube.': 'معرفی محصول، رابط کاربری و روند اصلی کار را مستقیماً از یوتیوب تماشا کنید.',
  'Power Assistant': 'دستیار افغان پاور',
  'Afghan Power assistant': 'دستیار افغان پاور',
  'Open Afghan Power assistant': 'بازکردن دستیار افغان پاور',
  'Close chat': 'بستن گفتگو',
  'Minimize chat': 'کوچک‌کردن گفتگو',
  'Send message': 'ارسال پیام',
  'Write your message...': 'پیام خود را بنویسید...',
  'Welcome to Afghan Power Group. How can we guide you today?': 'به افغان پاور گروپ خوش آمدید. امروز چگونه می‌توانیم راهنمایی‌تان کنیم؟',
  'Thanks — this is a static design preview. Our live assistant will be connected in the dynamic phase.': 'تشکر — این فعلاً پیش‌نمایش ثابت است. دستیار زنده در مرحله داینامیک وصل می‌شود.',
  'Online · Static Preview': 'آنلاین · پیش‌نمایش ثابت',
  'Logout': 'خروج',
  'SIGNED IN': 'وارد شده',
  'AFGHAN POWER ACCOUNT': 'حساب افغان پاور',
  'Phone number': 'شماره تماس',
  'Imran Afzali': 'عمران افضلی',
  'M. Samim Meyakhail': 'م. صمیم میاخیل',
  'Team Member 03': 'عضو تیم ۰۳',
  'Team Member 04': 'عضو تیم ۰۴',
  'Team Member 05': 'عضو تیم ۰۵',
  'Team Member 06': 'عضو تیم ۰۶',
  'Team Member 07': 'عضو تیم ۰۷',
  'Team Member 08': 'عضو تیم ۰۸',
  'Team Member 09': 'عضو تیم ۰۹',
  'Team Member 10': 'عضو تیم ۱۰',
  'One': 'یک',
  'AFGHAN POWER GROUP · PRODUCTS': 'افغان پاور گروپ · محصولات',
  'WhatsApp': 'واتساپ',
}
const ps: Dictionary = {
  ...
  'Explore products by company': 'محصولات د برخې له مخې وګورئ',
  'View all products': 'ټول محصولات وګورئ',
  'Educational Products': 'تعلیمي محصولات',
  'Travel Products': 'د سفر محصولات',
  'Tech Products': 'د ټکنالوژۍ محصولات',
  'Media Products': 'د رسنیو محصولات',
  'Study, admission, scholarship and student visa packages.': 'د زده‌کړې، پذیرش، بورس او محصل ویزې پکېجونه.',
  'Tourist visa, ticketing, family travel and tour packages.': 'د سیاحتي ویزې، ټکټ، کورني سفر او ټور پکېجونه.',
  'Ready-made databases, ERP platforms and business systems.': 'چمتو ډیټابیسونه، ERP پلیټفارمونه او سوداګریز سیستمونه.',
  'Advertising, social media, video and branding packages.': 'د اعلانونو، ټولنیزو رسنیو، ویډیو او برانډینګ پکېجونه.',
  'Product categories': 'د محصولاتو کټګورۍ',
  ...
  'ABOUT AFGHAN POWER GROUP': 'د افغان پاور ګروپ په اړه',
  'WHO WE ARE': 'موږ څوک یو',
  'OUR COMPANIES': 'زموږ شرکتونه',
  'WHY AFGHAN POWER GROUP': 'ولې افغان پاور ګروپ',
  '04 · CORE COMPANIES': '۰۴ · اصلي شرکتونه',
  'Group of Companies': 'د شرکتونو ګروپ',
  'Explore Education': 'تعلیمي خدمتونه وګورئ',
  'Explore Travel': 'د سفر خدمتونه وګورئ',
  'Explore Technology': 'د ټکنالوژۍ خدمتونه وګورئ',
  'Explore Media': 'د رسنیو خدمتونه وګورئ',
  'Explore our education, travel, technology and media services.': 'زموږ د زده‌کړو، سفر، ټکنالوژۍ او رسنیو خدمتونه وګورئ.',
  'From education and travel to technology and media, Afghan Power Group brings specialized services together under one trusted group.': 'له زده‌کړو او سفر څخه تر ټکنالوژۍ او رسنیو پورې، افغان پاور ګروپ تخصصي خدمتونه تر یوه باوري ګروپ لاندې راټولوي.',
  'One Group. Multiple': 'یو ګروپ. څو',
  'Specialized Companies.': 'تخصصي شرکتونه.',
  'MULTIPLE SOLUTIONS': 'څو حللارې',
  'Education · Travel · Tech · Media': 'زده کړې · سفر · ټکنالوژي · رسنۍ',
  'Study Abroad & Educational Services': 'په بهر کې زده کړه او تعلیمي خدمتونه',
  'University admissions, scholarships, study visa guidance and international education opportunities.': 'د پوهنتون پذیرش، بورسونه، د زده‌کړې ویزې لارښوونه او نړیوال تعلیمي فرصتونه.',
  'Travel, Visa & Ticketing Services': 'د سفر، ویزې او ټکټ خدمتونه',
  'Professional travel services including tourist visas, flight tickets and complete travel assistance.': 'مسلکي سفري خدمتونه، سیاحتي ویزې، هوایي ټکټونه او بشپړ سفري ملاتړ.',
  'Software & Digital Solutions': 'سافټویر او ډیجیټل حلونه',
  'Modern software solutions, business systems and custom technology built for organizations and businesses.': 'عصري سافټویر حلونه، سوداګریز سیستمونه او د سازمانونو او کاروبارونو لپاره ځانګړې ټکنالوژي.',
  'Creative Media & Digital Marketing': 'خلاقې رسنۍ او ډیجیټل بازارموندنه',
  'Creative media services designed to strengthen brands, promote businesses and produce professional digital content.': 'خلاق رسنیز خدمتونه د برانډونو د پیاوړتیا، سوداګرۍ د ودې او مسلکي ډیجیټل محتوا د تولید لپاره.',
  'Study abroad services': 'په بهر کې د زده‌کړې خدمتونه',
  'Tourist visa services': 'د سیاحتي ویزې خدمتونه',
  'Software & databases': 'سافټویر او ډیټابیسونه',
  'Media production': 'د رسنیو تولید',
  'Air Tickets': 'هوایي ټکټونه',
  'Travel Consultation': 'د سفر مشوره',
  'Custom Databases': 'ځانګړي ډیټابیسونه',
  'ERP Systems': 'ERP سیستمونه',
  'Mobile Applications': 'موبایل اپلیکیشنونه',
  'Video Production': 'ویډیو تولید',
  'Graphic Design': 'ګرافیک ډیزاین',
  'Digital Marketing': 'ډیجیټل بازارموندنه',
  'Smart Gold': 'سمارټ ګولډ',
  'Fuel Station ERP': 'د پټرول پمپ ERP',
  'Hospital Management': 'د روغتون مدیریت',
  'Pharmacy ERP': 'د درملتون ERP',
  'Restaurant System': 'د رستورانت سیستم',
  'Retail & Wholesale': 'پرچون او عمده پلور',
  'Back to Products': 'محصولاتو ته بېرته',
  'DETAILS': 'جزیات',
  'INFORMATION': 'معلومات',
  'RECOMMENDED': 'سپارښتنه شوې',
  'PRODUCT DEMO': 'د محصول ډیمو',
  'Live Demo': 'ژوندۍ ډیمو',
  'Watch the product overview, interface and key workflow directly from YouTube.': 'د محصول پېژندنه، انترفېس او اصلي کاري بهیر مستقیم له یوټیوب څخه وګورئ.',
  'Power Assistant': 'د افغان پاور مرستیال',
  'Afghan Power assistant': 'د افغان پاور مرستیال',
  'Open Afghan Power assistant': 'د افغان پاور مرستیال پرانیزئ',
  'Close chat': 'چټ بند کړئ',
  'Minimize chat': 'چټ کوچنی کړئ',
  'Send message': 'پیغام واستوئ',
  'Write your message...': 'خپل پیغام ولیکئ...',
  'Welcome to Afghan Power Group. How can we guide you today?': 'افغان پاور ګروپ ته ښه راغلاست. نن څنګه مرسته درسره وکړو؟',
  'Thanks — this is a static design preview. Our live assistant will be connected in the dynamic phase.': 'مننه — دا اوس ثابت مخکتنه ده. ژوندی مرستیال به په داینامیک پړاو کې ونښلول شي.',
  'Online · Static Preview': 'آنلاین · ثابت مخکتنه',
  'Logout': 'وتل',
  'SIGNED IN': 'ننوتلی',
  'AFGHAN POWER ACCOUNT': 'د افغان پاور حساب',
  'Phone number': 'د تلیفون شمېره',
  'Imran Afzali': 'عمران افضلي',
  'M. Samim Meyakhail': 'م. صمیم میاخیل',
  'Team Member 03': 'د ټیم غړی ۰۳',
  'Team Member 04': 'د ټیم غړی ۰۴',
  'Team Member 05': 'د ټیم غړی ۰۵',
  'Team Member 06': 'د ټیم غړی ۰۶',
  'Team Member 07': 'د ټیم غړی ۰۷',
  'Team Member 08': 'د ټیم غړی ۰۸',
  'Team Member 09': 'د ټیم غړی ۰۹',
  'Team Member 10': 'د ټیم غړی ۱۰',
  'One': 'یو',
  'All rights reserved.': 'ټول حقوق خوندي دي.',

  'AFGHAN POWER GROUP · PRODUCTS': 'افغان پاور ګروپ · محصولات',
  'WhatsApp': 'واټساپ',
  'Explore Our Products & Packages': 'زموږ محصولات او پکېجونه وګورئ',
}
